...
if ( ! function_exists( 'rsvp_block_styles' ) ) {
	function rsvp_block_styles() {
        if (!is_admin()) {
            ...
            wp_enqueue_style( 'main_style', get_stylesheet_directory_uri() . '/assets/css/style.css', [], "1.5" );
            // add js lib
            ...
            wp_enqueue_script('main_script', get_stylesheet_directory_uri() . '/assets/js/main.js', [], [], "1.3");
        }
    }
}
