...
<section id="section-contactus" class="py-5 bg-tgrey">
    <div class="container my-5">
            ...
            <div class="col-md-7">
                <form id="contact-form" action="/contact" method="POST" class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control rounded-0 border-0 p-2" id="contact_name" name="contact_name" placeholder="Your Name" required>
                    </div>
                    <div class="col-md-6">
                        <label for="inputEmail" class="form-label">Email*</label>
                        <input type="email" class="form-control rounded-0 border-0 p-2" id="contact_email" name="contact_email" placeholder="Email" required>
                    </div>
                    <div class="col-12">
                        <label for="inputMessage" class="form-label">Message</label>
                        <textarea minlength="10" class="form-control rounded-0 border-0 p-2" id="contact_message" rows="5" name="contact_message" placeholder="Write your enquiry here" required></textarea>
                    </div>
        ...
        <div class="mt-4 text-center">
            <a target="_blank" href="<?= carbon_get_theme_option('rsvp_facebook') ?>" class="h2 me-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
                </svg>
            </a>
            <a target="_blank" href="<?= carbon_get_theme_option('rsvp_instagram') ?>" class="h2 me-4">
            ...
            <a target="_blank" href="<?= carbon_get_theme_option('rsvp_linkedin') ?>" class="h2 me-4">
            ...
            <a target="_blank" href="<?= carbon_get_theme_option('rsvp_twitter') ?>" class="h2 me-4">
