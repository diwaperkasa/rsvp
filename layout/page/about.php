    ...
    <div class="container-fluid">
            ...
            <div class="col-md-6">
                <div class="position-relative">
                    <div class="text-about">
                        ...
                        <h1 class="fs-1 fw-normal fst-italic">Who We Are</h1>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row ">
            <div class="col-md-6 offset-md-6">
                <div class="p-3">
                    <h1 class="display-5 mb-5 lh-1">At R.S.V.P, we think outside the box to make your campaign a <span class="fst-italic">success</span></h1>
                    ...
                    <div class="mb-5">
                        <a class="fw-normal h5 fst-italic text-decoration-underline" href="/services" role="button">View All Service</a>
                        <span class="ms-2">
