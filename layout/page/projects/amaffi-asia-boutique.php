    ...
    <div class="item h-100">
        <div class="row g-0 h-100">
            <div class="col-md-6 p-4 p-md-0 ">
                <div class="w-100 h-100 project-imgbg" style="background: url('<?= get_stylesheet_directory_uri() . "/assets/img/AMAFFI-left.jpg" ?>') no-repeat center; background-size: cover;">
                </div>
            </div>
            <div class="col-md-6">
